...
function forceconnect(){
	...
	if (!$link) {
		...
		if (!$link){
			die(__FILE__. __LINE__. "Fatal: No puedo conectar a la base de datos");
		}

		$bd_seleccionada = mysql_select_db($ges_database, $link);
		if (!$bd_seleccionada) {
		    die ("No se puede usar '$ges_database' : " . mysql_error());
		}
